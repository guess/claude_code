defmodule ClaudeCode.Message.HookResponseMessage do
  @moduledoc """
  ...
  @doc """
  Creates a new HookResponseMessage from JSON data.

  The `"outcome"` string is parsed to an atom (`:success`, `:error`, or `:cancelled`).

  ## Examples

      iex> HookResponseMessage.new(%{
      ...>   "type" => "system",
      ...>   "subtype" => "hook_response",
      ...
      ...>   "outcome" => "success"
      ...> })
      {:ok, %HookResponseMessage{type: :system, subtype: :hook_response, outcome: :success, ...}}

      iex> HookResponseMessage.new(%{"type" => "assistant"})
  ...
  @doc """
  Type guard to check if a value is a HookResponseMessage.
  """
  @spec hook_response_message?(any()) :: boolean()
  def hook_response_message?(%__MODULE__{type: :system, subtype: :hook_response}), do: true
  def hook_response_message?(_), do: false
...
defimpl Jason.Encoder, for: ClaudeCode.Message.HookResponseMessage do
...
defimpl JSON.Encoder, for: ClaudeCode.Message.HookResponseMessage do
