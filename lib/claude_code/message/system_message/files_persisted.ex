defmodule ClaudeCode.Message.SystemMessage.FilesPersisted do
  @moduledoc """
  ...
  def files_persisted?(%__MODULE__{type: :system, subtype: :files_persisted}), do: true
  def files_persisted?(_), do: false
